...
engine = create_engine('sqlite:///:memory:', echo=True) # Para usar una base de datos en disco, descomentar la siguiente línea
#engine = create_engine('sqlite:///usuarios.db', echo=True) # Base de datos en disco
